...
class ReservationTicket:
    ...
    @property  #This is an instance property
...
ticket = ReservationTicket(customer_name="Echendu josh ", hotel_object=hotel1)

# Caling the property method
print(ticket.the_customer_name) # there is no parenthesis bcos we dont have to call it, that is, it is already a property

# Calling an instance method of a class
